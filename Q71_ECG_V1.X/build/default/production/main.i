...
# 102 "./mcc_generated_files/system/../data_streamer/data_streamer.h"
void DataStreamer_Initialize(void);
# 111 "./mcc_generated_files/system/../data_streamer/data_streamer.h"
void DataStreamer_FrameSend(void * package, size_t length);
# 120 "./mcc_generated_files/system/../data_streamer/data_streamer.h"
...
void DS_Frame_Update(void){
    ...
    DataStreamer.adc_error_sq_sqrt_sqrt = (uint8_t) sqrtf(DataStreamer.adc_error_sq);
    SEND_FRAME = 1;
